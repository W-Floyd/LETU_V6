...
#define STRING_CONFIG_H_AUTHOR "Zachary Read, LETUprintV6 FW Version 1.0.0" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "LETUprintV6"
...
#define TEMP_HYSTERESIS 5 //3       // (degC) range of +/- temperatures considered "close" to the target one
 ...
 * essentially noise-proof without sacrificing accurac.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 95.24 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 12, 10000 }
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE    0 // 10 // Z Clearance for Deploy/Stow
...
#define Z_PROBE_OFFSET_RANGE_MAX 12
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET 5.5    // (mm) An inset for corner leveling
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 20), (Y_MAX_POS - 5), 20 }
...
#define ST7920_DELAY_3 DELAY_NS(128) // this is the defaults for a 16mhz processor (ie a mega2560)
